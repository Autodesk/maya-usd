...
class testUsdExportMaterialScope(unittest.TestCase):
    ...
    def testMaterialScopeOneGroupNoDefaultPrim(self):
        ...
        expectedMtlPaths = [
            '/Materials/standardSurface2SG/standardSurface2',
            '/Materials/standardSurface3SG/standardSurface3',
            '/Materials/standardSurface4SG/standardSurface4',
            '/Materials/standardSurface5SG/standardSurface5',
        ]
    ...
    def testMaterialScopeTwoGroupsWithDefaultPrim(self):
        ...
        expectedMtlPaths = [
            ...
            '/group1/Materials/standardSurface4SG/standardSurface4',
            '/group1/Materials/standardSurface5SG/standardSurface5',
        ]
        self._verifyMaterials(expectedMtlPaths)
