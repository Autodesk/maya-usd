...
class AttributeTestCase(unittest.TestCase):
    ...
    def testSingleAttributeBlocking(self):
        ''' Authoring attribute(s) in weaker layer(s) are not permited if there exist opinion(s) in stronger layer(s).'''
    ...
    def testTransformationAttributeBlocking(self):
        ...
        rootLayer = stage.GetRootLayer()
        subLayerCId = cmds.mayaUsdLayerEditor(rootLayer.identifier, edit=True, addAnonymous="SubLayerC")[0]
        subLayerBId = cmds.mayaUsdLayerEditor(rootLayer.identifier, edit=True, addAnonymous="SubLayerB")[0]
        subLayerAId = cmds.mayaUsdLayerEditor(rootLayer.identifier, edit=True, addAnonymous="SubLayerA")[0]

        # check to see the sublayers added
        addedLayers = [subLayerAId, subLayerBId, subLayerCId]
        self.assertEqual(rootLayer.subLayerPaths, addedLayers)

        # set the edit target to LayerB
        cmds.mayaUsdEditTarget(proxyShapePath, edit=True, editTarget=subLayerBId)
        ...
        cmds.mayaUsdEditTarget(proxyShapePath, edit=True, editTarget=subLayerCId)
        ...
        cmds.mayaUsdEditTarget(proxyShapePath, edit=True, editTarget=subLayerAId)
