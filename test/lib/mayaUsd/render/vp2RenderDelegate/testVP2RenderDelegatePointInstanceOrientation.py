...
class testVP2RenderDelegatePointInstanceOrientation(imageUtils.ImageDiffingTestCase):
    """
    ...
    def setUpClass(cls):
        ...
        cls._baselineDir = os.path.join(inputPath,
            'VP2RenderDelegatePointInstanceOrientationTest', 'baseline')
    ...
    def _StartTest(self, testName):
        ...
        testFile = testUtils.getTestScene("pointInstances", self._testName + ".usda")
    ...
    def testPerInstanceInheritedData(self):
        self._StartTest('point_instanced_axis')
