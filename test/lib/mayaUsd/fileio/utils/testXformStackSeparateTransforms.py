...
class testXformStackSeparateTransforms(unittest.TestCase):
    ...
    def testMayaStack(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ('translateX',            False, UsdGeom.XformOp.TypeTranslateX),
                ('translateY',            False, UsdGeom.XformOp.TypeTranslateY),
                ('translateZ',            False, UsdGeom.XformOp.TypeTranslateZ),
                ...
                ('rotateX',               False, UsdGeom.XformOp.TypeRotateX),
                ('rotateY',               False, UsdGeom.XformOp.TypeRotateY),
                ('rotateZ',               False, UsdGeom.XformOp.TypeRotateZ),
                ...
                ('scaleX',                False, UsdGeom.XformOp.TypeScaleX),
                ('scaleY',                False, UsdGeom.XformOp.TypeScaleY),
                ('scaleZ',                False, UsdGeom.XformOp.TypeScaleZ),
    ...
    def testIsCompatibleType(self):
        ...
        for opType in UsdGeom.XformOp.Type.allValues:
            if opType == UsdGeom.XformOp.TypeTranslateX or opType == UsdGeom.XformOp.TypeTranslateY or opType == UsdGeom.XformOp.TypeTranslateZ:
                ...
                self.assertTrue(translateOp.IsCompatibleType(opType),
                                "{} should be compatible with {}".format(
                                    translateOp.GetName(),
                                    opType))
            elif opType == UsdGeom.XformOp.TypeTranslate:
                self.assertTrue(translateOp.IsCompatibleType(opType),
                                "{} should be compatible with {}".format(
                                    translateOp.GetName(),
                                    opType))
    ...
    def testGetSize(self):
        mayaStack = mayaUsdLib.XformStack.MayaStack()
        self.assertEqual(len(mayaStack), 22)
        self.assertEqual(mayaStack.GetSize(), 22)
        commonStack = mayaUsdLib.XformStack.CommonStack()
    ...
    def testIndexing(self):
        ...
        self.assertEqual(mayaStack[1].GetName(), 'translateX')
        self.assertEqual(mayaStack[2].GetName(), 'translateY')
        self.assertEqual(mayaStack[3].GetName(), 'translateZ')
        self.assertEqual(mayaStack[4].GetName(), 'pivot')
        self.assertEqual(mayaStack[5].GetName(), 'rotatePivotTranslate')
        self.assertEqual(mayaStack[6].GetName(), 'rotatePivot')
        self.assertEqual(mayaStack[7].GetName(), 'rotate')
        self.assertEqual(mayaStack[8].GetName(), 'rotateX')
        self.assertEqual(mayaStack[9].GetName(), 'rotateY')
        self.assertEqual(mayaStack[10].GetName(), 'rotateZ')
        self.assertEqual(mayaStack[11].GetName(), 'rotateAxis')
        self.assertEqual(mayaStack[12].GetName(), 'rotatePivot')
        self.assertEqual(mayaStack[13].GetName(), 'scalePivotTranslate')
        self.assertEqual(mayaStack[14].GetName(), 'scalePivot')
        self.assertEqual(mayaStack[15].GetName(), 'shear')
        self.assertEqual(mayaStack[16].GetName(), 'scale')
        self.assertEqual(mayaStack[17].GetName(), 'scaleX')
        self.assertEqual(mayaStack[18].GetName(), 'scaleY')
        self.assertEqual(mayaStack[19].GetName(), 'scaleZ')
        self.assertEqual(mayaStack[20].GetName(), 'scalePivot')
        self.assertEqual(mayaStack[21].GetName(), 'pivot')

        self.assertEqual(mayaStack[-22].GetName(), 'translate')
        self.assertEqual(mayaStack[-21].GetName(), 'translateX')
        self.assertEqual(mayaStack[-20].GetName(), 'translateY')
        self.assertEqual(mayaStack[-19].GetName(), 'translateZ')
        self.assertEqual(mayaStack[-18].GetName(), 'pivot')
        self.assertEqual(mayaStack[-17].GetName(), 'rotatePivotTranslate')
        self.assertEqual(mayaStack[-16].GetName(), 'rotatePivot')
        self.assertEqual(mayaStack[-15].GetName(), 'rotate')
        self.assertEqual(mayaStack[-14].GetName(), 'rotateX')
        self.assertEqual(mayaStack[-13].GetName(), 'rotateY')
        self.assertEqual(mayaStack[-12].GetName(), 'rotateZ')
        self.assertEqual(mayaStack[-11].GetName(), 'rotateAxis')
        self.assertEqual(mayaStack[-10].GetName(), 'rotatePivot')
        self.assertEqual(mayaStack[-9].GetName(), 'scalePivotTranslate')
        self.assertEqual(mayaStack[-8].GetName(), 'scalePivot')
        self.assertEqual(mayaStack[-7].GetName(), 'shear')
        self.assertEqual(mayaStack[-6].GetName(), 'scale')
        self.assertEqual(mayaStack[-5].GetName(), 'scaleX')
        self.assertEqual(mayaStack[-4].GetName(), 'scaleY')
        self.assertEqual(mayaStack[-3].GetName(), 'scaleZ')
        ...
        self.assertRaises(IndexError, getStackItem, 22)
        self.assertRaises(IndexError, getStackItem, 24)
        self.assertRaises(IndexError, getStackItem, 300)
        self.assertRaises(IndexError, getStackItem, -24)
        self.assertRaises(IndexError, getStackItem, -30)
    ...
    def testFindOpIndex(self):
        ...
        self.assertEqual(mayaStack.FindOpIndex('translateX'), 1)
        self.assertEqual(mayaStack.FindOpIndex('translateY'), 2)
        self.assertEqual(mayaStack.FindOpIndex('translateZ'), 3)
        self.assertEqual(mayaStack.FindOpIndex('pivot'), 4)
        self.assertEqual(mayaStack.FindOpIndex('rotatePivotTranslate'), 5)
        self.assertEqual(mayaStack.FindOpIndex('rotatePivot'), 6)
        self.assertEqual(mayaStack.FindOpIndex('rotate'), 7)
        self.assertEqual(mayaStack.FindOpIndex('rotateX'), 8)
        self.assertEqual(mayaStack.FindOpIndex('rotateY'), 9)
        self.assertEqual(mayaStack.FindOpIndex('rotateZ'), 10)
        self.assertEqual(mayaStack.FindOpIndex('rotateAxis'), 11)
        self.assertEqual(mayaStack.FindOpIndex('scalePivotTranslate'), 13)
        self.assertEqual(mayaStack.FindOpIndex('scalePivot'), 14)
        self.assertEqual(mayaStack.FindOpIndex('shear'), 15)
        self.assertEqual(mayaStack.FindOpIndex('scale'), 16)
        self.assertEqual(mayaStack.FindOpIndex('scaleX'), 17)
        self.assertEqual(mayaStack.FindOpIndex('scaleY'), 18)
        self.assertEqual(mayaStack.FindOpIndex('scaleZ'), 19)

        self.assertEqual(mayaStack.FindOpIndex('translate', isInvertedTwin=False), 0)
        self.assertEqual(mayaStack.FindOpIndex('pivot', isInvertedTwin=False), 4)
        self.assertEqual(mayaStack.FindOpIndex('rotatePivotTranslate', isInvertedTwin=False), 5)
        self.assertEqual(mayaStack.FindOpIndex('rotatePivot', isInvertedTwin=False), 6)
        self.assertEqual(mayaStack.FindOpIndex('rotate', isInvertedTwin=False), 7)
        self.assertEqual(mayaStack.FindOpIndex('rotateAxis', isInvertedTwin=False), 11)
        #assertEqual(mayaStack.FindOpIndex('rotatePivot', isInvertedTwin=False), 6)
        self.assertEqual(mayaStack.FindOpIndex('scalePivotTranslate', isInvertedTwin=False), 13)
        self.assertEqual(mayaStack.FindOpIndex('scalePivot', isInvertedTwin=False), 14)
        self.assertEqual(mayaStack.FindOpIndex('shear', isInvertedTwin=False), 15)
        self.assertEqual(mayaStack.FindOpIndex('scale', isInvertedTwin=False), 16)
        ...
        self.assertEqual(mayaStack.FindOpIndex('pivot', False), 4)
        self.assertEqual(mayaStack.FindOpIndex('rotatePivotTranslate', False), 5)
        self.assertEqual(mayaStack.FindOpIndex('rotatePivot', False), 6)
        self.assertEqual(mayaStack.FindOpIndex('rotate', False), 7)
        self.assertEqual(mayaStack.FindOpIndex('rotateAxis', False), 11)
        #assertEqual(mayaStack.FindOpIndex('rotatePivot', False), 6)
        self.assertEqual(mayaStack.FindOpIndex('scalePivotTranslate', False), 13)
        self.assertEqual(mayaStack.FindOpIndex('scalePivot', False), 14)
        self.assertEqual(mayaStack.FindOpIndex('shear', False), 15)
        self.assertEqual(mayaStack.FindOpIndex('scale', False), 16)
        ...
        self.assertEqual(mayaStack.FindOpIndex('rotatePivot', isInvertedTwin=True), 12)
        ...
        self.assertEqual(mayaStack.FindOpIndex('scalePivot', isInvertedTwin=True), 20)
        ...
        self.assertEqual(mayaStack.FindOpIndex('rotatePivot', True), 12)
        ...
        self.assertEqual(mayaStack.FindOpIndex('scalePivot', True), 20)

        self.assertIs(mayaStack.FindOpIndex('pivot'), 4)
        self.assertIs(mayaStack.FindOpIndex('pivot', isInvertedTwin=True), 21)
        self.assertIs(mayaStack.FindOpIndex('pivot', True), 21)
        self.assertIs(mayaStack.FindOpIndex('pivot', isInvertedTwin=False), 4)
        self.assertIs(mayaStack.FindOpIndex('pivot', False), 4)
    ...
    def testFindOpIndexPair(self):
        ...
        self.assertEqual(mayaStack.FindOpIndexPair('pivot'), (4, 21))
        self.assertEqual(mayaStack.FindOpIndexPair('rotatePivotTranslate'), (5, None))
        self.assertEqual(mayaStack.FindOpIndexPair('rotatePivot'), (6, 12))
        self.assertEqual(mayaStack.FindOpIndexPair('rotate'), (7, None))
        self.assertEqual(mayaStack.FindOpIndexPair('rotateAxis'), (11, None))
        self.assertEqual(mayaStack.FindOpIndexPair('scalePivotTranslate'), (13, None))
        self.assertEqual(mayaStack.FindOpIndexPair('scalePivot'), (14, 20))
        self.assertEqual(mayaStack.FindOpIndexPair('shear'), (15, None))
        self.assertEqual(mayaStack.FindOpIndexPair('scale'), (16, None))
    ...
    def makeMayaStackAttrs(self):
        ...
        self.ops['translateX'] = self.xform.AddTranslateOp(opSuffix='translateX')
        self.ops['translateY'] = self.xform.AddTranslateOp(opSuffix='translateY')
        self.ops['translateZ'] = self.xform.AddTranslateOp(opSuffix='translateZ')
        ...
        self.ops['rotateX'] = self.xform.AddRotateXOp(opSuffix='rotateX')
        self.ops['rotateY'] = self.xform.AddRotateYOp(opSuffix='rotateY')
        self.ops['rotateZ'] = self.xform.AddRotateZOp(opSuffix='rotateZ')
        ...
        self.ops['scaleX'] = self.xform.AddScaleOp(opSuffix='scaleX')
        self.ops['scaleY'] = self.xform.AddScaleOp(opSuffix='scaleY')
        self.ops['scaleZ'] = self.xform.AddScaleOp(opSuffix='scaleZ')
