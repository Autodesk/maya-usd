...
if (UFE_FOUND)
    # This will follow a message "-- Found UFE: <path> ..."
    message(STATUS "  Version: ${UFE_VERSION}")
    message(STATUS "  Include dir: ${UFE_INCLUDE_DIR}")
    message(STATUS "  Library: ${UFE_LIBRARY}")
    message(STATUS "  Preview features: ${UFE_PREVIEW_FEATURES}")
endif()
...
set(UFE_HAS_COLOR_MANAGEMENT_HANDLER FALSE CACHE INTERNAL "cmHandler")
if(UFE_INCLUDE_DIR AND EXISTS "${UFE_INCLUDE_DIR}/ufe/colorManagementHandler.h")
