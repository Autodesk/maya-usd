...
if(DEFINED GULRAK_SOURCE_DIR)
    ...
    string(TOUPPER ${CONTENT_NAME} UPPERGULRAK)
    mark_as_advanced(FETCHCONTENT_SOURCE_DIR_${UPPERGULRAK})
    mark_as_advanced(FETCHCONTENT_UPDATES_DISCONNECTED_${UPPERGULRAK})
