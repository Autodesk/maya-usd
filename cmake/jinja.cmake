...
function(init_markupsafe)
    ...
    if (NOT MARKUPSAFE_FOUND)
        ...
        set(MARKUPSAFE_PACKAGE_NAME "MarkupSafe-1.1.0")
        set(MARKUPSAFE_ROOT "${MARKUPSAFE_LOCATION}/${MARKUPSAFE_PACKAGE_NAME}/src")
...
function(init_jinja)
    ...
    if (NOT JINJA2_FOUND)
        ...
        set(JINJA_PACKAGE_NAME "Jinja2-2.10")
        set(JINJA_ROOT "${JINJA_LOCATION}/${JINJA_PACKAGE_NAME}")
