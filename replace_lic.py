...
mode_group.add_argument('--mode', choices=['pxr', 'al', 'luma', 'all'], default='all',
...
mode_group.add_argument('--luma', help='Replace luma lics',
    action='store_const', const='luma', dest='mode')
...
old_luma_cpp_lic = """// Licensed under the Apache License, Version 2.0 (the "Apache License")
// with the following modification you may not use this file except in
// compliance with the Apache License and the following modification to it:
// Section 6. Trademarks. is deleted and replaced with:
//
