...
{
    return GetPrim().GetAttribute(MayaUsdCore_SchemasTokens->mayaReference);
}

UsdAttribute
AL_usd_MayaReference::CreateMayaReferenceAttr(VtValue const &defaultValue, bool writeSparsely) const
{
    return UsdSchemaBase::_CreateAttr(MayaUsdCore_SchemasTokens->mayaReference,
...
{
    return GetPrim().GetAttribute(MayaUsdCore_SchemasTokens->mayaNamespace);
}

UsdAttribute
AL_usd_MayaReference::CreateMayaNamespaceAttr(VtValue const &defaultValue, bool writeSparsely) const
{
    return UsdSchemaBase::_CreateAttr(MayaUsdCore_SchemasTokens->mayaNamespace,
...
AL_usd_MayaReference::GetSchemaAttributeNames(bool includeInherited)
{
    static TfTokenVector localNames = {
        MayaUsdCore_SchemasTokens->mayaReference,
        MayaUsdCore_SchemasTokens->mayaNamespace,
    };
