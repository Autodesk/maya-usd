...
//----------------------------------------------------------------------------------------------------------------------
static void inverseRotate(const GfVec3f c, const GfVec3f p[3], GfVec3f& m)
{
  m[0] = c * p[0] / (p[0] * p[0]);
  m[1] = c * p[1] / (p[1] * p[1]);
  m[2] = c * p[2] / (p[2] * p[2]);
...
//----------------------------------------------------------------------------------------------------------------------
static void multiplyByInverse(const GfVec3f c[3], const GfVec3f p[3], GfVec3f m[3])
{
  inverseRotate(c[0], p, m[0]);
  inverseRotate(c[1], p, m[1]);
  inverseRotate(c[2], p, m[2]);
}
