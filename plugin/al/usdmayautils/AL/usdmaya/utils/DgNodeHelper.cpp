...
MStatus DgNodeHelper::setHalfArray(MObject node, MObject attribute, const GfHalf* const values, const size_t count)
{
  ...
  {
    float f[8];
    MayaUsd::Utils::half2float_8f(values + j, f);
  ...
  {
    float f[4];
    MayaUsd::Utils::half2float_4f(values + count8, f);
  ...
  switch(count & 0x3)
  {
  case 3: plug.elementByLogicalIndex(count8 + 2).setFloat(MayaUsd::Utils::half2float_1f(values[count8 + 2]));
  case 2: plug.elementByLogicalIndex(count8 + 1).setFloat(MayaUsd::Utils::half2float_1f(values[count8 + 1]));
  case 1: plug.elementByLogicalIndex(count8 + 0).setFloat(MayaUsd::Utils::half2float_1f(values[count8 + 0]));
  default:
    break;
  }
...
MStatus DgNodeHelper::setVec2Array(MObject node, MObject attribute, const GfHalf* const values, const size_t count)
{
  ...
  {
    float f[4];
    MayaUsd::Utils::half2float_4f(values + count4 * 2, f);
  ...
  if(count & 0x1)
  {
    ...
    v0.child(0).setFloat(MayaUsd::Utils::half2float_1f(values[count4 * 2]));
    v0.child(1).setFloat(MayaUsd::Utils::half2float_1f(values[count4 * 2 + 1]));
  }
...
MStatus DgNodeHelper::setVec3Array(MObject node, MObject attribute, const GfHalf* const values, const size_t count)
{
  ...
  for(size_t i = 0, j = 0; i != count8; i += 8, j += 24)
  {
    float f[24];
    MayaUsd::Utils::half2float_8f(values + j, f);
    MayaUsd::Utils::half2float_8f(values + j + 8, f + 8);
    MayaUsd::Utils::half2float_8f(values + j + 16, f + 16);
  ...
  for(size_t i = count8, j = count8 * 3; i != count; ++i, j += 3)
  {
    ...
    h[1] = values[j + 1];
    h[2] = values[j + 2];
    MayaUsd::Utils::half2float_4f(h, f);
    auto v = plug.elementByLogicalIndex(i);
...
MStatus DgNodeHelper::setVec4Array(MObject node, MObject attribute, const GfHalf* const values, const size_t count)
{
  ...
  {
    float f[4];
    MayaUsd::Utils::half2float_4f(values + count2 * 4, f);
...
MStatus DgNodeHelper::getHalfArray(MObject node, MObject attribute, GfHalf* const values, const size_t count)
{
  ...
  for(uint32_t i = 0; i < count8; i += 8)
  {
    ...
    MayaUsd::Utils::float2half_8f(f, values + i);
  }
  ...
  if(count & 0x4)
  {
    ...
    MayaUsd::Utils::float2half_4f(f, values + count8);
    count8 += 4;
  }

  switch(count & 0x3)
  {
  case 3: values[count8 + 2] = MayaUsd::Utils::float2half_1f(plug.elementByLogicalIndex(count8 + 2).asFloat());
  case 2: values[count8 + 1] = MayaUsd::Utils::float2half_1f(plug.elementByLogicalIndex(count8 + 1).asFloat());
  case 1: values[count8 + 0] = MayaUsd::Utils::float2half_1f(plug.elementByLogicalIndex(count8 + 0).asFloat());
  default: break;
  }
  return MS::kSuccess;
}
...
MStatus DgNodeHelper::getVec2Array(MObject node, MObject attribute, GfHalf* const values, const size_t count)
{
  ...
  for(uint32_t i = 0, j = 0; i < count4; i += 4, j += 8)
  {
    ...
    MayaUsd::Utils::float2half_8f(f, values + j);
  }
  ...
  if(count & 0x2)
  {
    ...
    f[2] = v1.child(0).asFloat();
    f[3] = v1.child(1).asFloat();
    MayaUsd::Utils::float2half_4f(f, values + count4 * 2);
    count4 += 2;
  }
  ...
  if(count & 0x1)
  {
    ...
    values[count4 * 2 + 0] = MayaUsd::Utils::float2half_1f(v.child(0).asFloat());
    values[count4 * 2 + 1] = MayaUsd::Utils::float2half_1f(v.child(1).asFloat());
  }
...
MStatus DgNodeHelper::getVec3Array(MObject node, MObject attribute, GfHalf* const values, const size_t count)
{
  ...
  for(uint32_t i = 0, j = 0; i < count8; i += 8, j += 24)
  {
    ...
    MayaUsd::Utils::float2half_8f(r, values + j);
    MayaUsd::Utils::float2half_8f(r + 8, values + j + 8);
    MayaUsd::Utils::float2half_8f(r + 16, values + j + 16);
  }
  ...
  for(uint32_t i = count8, j = count8 * 3; i < count; ++i, j += 3)
  {
    ...
    v[3] = 0;
    MayaUsd::Utils::float2half_4f(v, h);
    values[j + 0] = h[0];
    values[j + 1] = h[1];
    values[j + 2] = h[2];
  }
...
MStatus DgNodeHelper::getVec4Array(MObject node, MObject attribute, GfHalf* const values, const size_t count)
{
  ...
  if(count & 0x1)
  {
    ...
    f[2] = v0.child(2).asFloat();
    f[3] = v0.child(3).asFloat();
    MayaUsd::Utils::float2half_4f(f, values + count2 * 4);
  }
...
MStatus DgNodeHelper::setVec2(MObject node, MObject attr, const GfHalf* const xy)
{
  ...
  MPlug plug(node, attr);
  AL_MAYA_CHECK_ERROR(plug.child(0).setValue(MayaUsd::Utils::float2half_1f(xy[0])), errorString);
  AL_MAYA_CHECK_ERROR(plug.child(1).setValue(MayaUsd::Utils::float2half_1f(xy[1])), errorString);
  return MS::kSuccess;
}
...
MStatus DgNodeHelper::setVec3(MObject node, MObject attr, const GfHalf* const xyz)
{
  ...
  MPlug plug(node, attr);
  AL_MAYA_CHECK_ERROR(plug.child(0).setValue(MayaUsd::Utils::float2half_1f(xyz[0])), errorString);
  AL_MAYA_CHECK_ERROR(plug.child(1).setValue(MayaUsd::Utils::float2half_1f(xyz[1])), errorString);
  AL_MAYA_CHECK_ERROR(plug.child(2).setValue(MayaUsd::Utils::float2half_1f(xyz[2])), errorString);
  return MS::kSuccess;
}
...
MStatus DgNodeHelper::setVec4(MObject node, MObject attr, const GfHalf* const xyzw)
{
  ...
  MPlug plug(node, attr);
  AL_MAYA_CHECK_ERROR(plug.child(0).setValue(MayaUsd::Utils::float2half_1f(xyzw[0])), errorString);
  AL_MAYA_CHECK_ERROR(plug.child(1).setValue(MayaUsd::Utils::float2half_1f(xyzw[1])), errorString);
  AL_MAYA_CHECK_ERROR(plug.child(2).setValue(MayaUsd::Utils::float2half_1f(xyzw[2])), errorString);
  AL_MAYA_CHECK_ERROR(plug.child(3).setValue(MayaUsd::Utils::float2half_1f(xyzw[3])), errorString);
  return MS::kSuccess;
}
...
MStatus DgNodeHelper::getVec2(MObject node, MObject attr, GfHalf* xy)
{
  ...
  xy[0] = MayaUsd::Utils::float2half_1f(fxy[0]);
  xy[1] = MayaUsd::Utils::float2half_1f(fxy[1]);
  return status;
}
...
MStatus DgNodeHelper::getVec3(MObject node, MObject attr, GfHalf* xyz)
{
  ...
  MayaUsd::Utils::float2half_4f(fxyz, xyzw);
  xyz[0] = xyzw[0];
  xyz[1] = xyzw[1];
  xyz[2] = xyzw[2];
  return status;
...
MStatus DgNodeHelper::getVec4(MObject node, MObject attr, GfHalf* xyzw)
{
  ...
  MayaUsd::Utils::float2half_4f(fxyzw, xyzw);
  return status;
}
