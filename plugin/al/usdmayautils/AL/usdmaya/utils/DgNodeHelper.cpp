    ...
    const size_t        count)
{
    ...
    for (size_t j = 0; j != count8; j += 8) {
        float f[8];
        UsdUfe::half2float_8f(values + j, f);
    ...
    if (count & 0x4) {
        float f[4];
        UsdUfe::half2float_4f(values + count8, f);
    ...
    switch (count & 0x3) {
    case 3:
        plug.elementByLogicalIndex(count8 + 2).setFloat(UsdUfe::half2float_1f(values[count8 + 2]));
    case 2:
        plug.elementByLogicalIndex(count8 + 1).setFloat(UsdUfe::half2float_1f(values[count8 + 1]));
    case 1:
        plug.elementByLogicalIndex(count8 + 0).setFloat(UsdUfe::half2float_1f(values[count8 + 0]));
    default: break;
    }
    ...
    const size_t        count)
{
    ...
    if (count & 0x2) {
        float f[4];
        UsdUfe::half2float_4f(values + count4 * 2, f);
    ...
    if (count & 0x1) {
        ...
        v0.child(0).setFloat(UsdUfe::half2float_1f(values[count4 * 2]));
        v0.child(1).setFloat(UsdUfe::half2float_1f(values[count4 * 2 + 1]));
    }
    ...
    const size_t        count)
{
    ...
    for (size_t i = 0, j = 0; i != count8; i += 8, j += 24) {
        float f[24];
        UsdUfe::half2float_8f(values + j, f);
        UsdUfe::half2float_8f(values + j + 8, f + 8);
        UsdUfe::half2float_8f(values + j + 16, f + 16);
    ...
    const size_t        count)
{
    ...
    if (count & 0x1) {
        float f[4];
        UsdUfe::half2float_4f(values + count2 * 4, f);
    ...
    const size_t  count)
{
    ...
    for (uint32_t i = 0; i < count8; i += 8) {
        ...
        UsdUfe::float2half_8f(f, values + i);
    }
    ...
    if (count & 0x4) {
        ...
        UsdUfe::float2half_4f(f, values + count8);
        count8 += 4;
    }
    ...
    case 3:
        values[count8 + 2]
            = UsdUfe::float2half_1f(plug.elementByLogicalIndex(count8 + 2).asFloat());
    case 2:
        values[count8 + 1]
            = UsdUfe::float2half_1f(plug.elementByLogicalIndex(count8 + 1).asFloat());
    case 1:
        values[count8 + 0]
            = UsdUfe::float2half_1f(plug.elementByLogicalIndex(count8 + 0).asFloat());
    default: break;
    }
    return MS::kSuccess;
}
    ...
    const size_t  count)
{
    ...
    for (uint32_t i = 0, j = 0; i < count4; i += 4, j += 8) {
        ...
        UsdUfe::float2half_8f(f, values + j);
    }
    ...
    if (count & 0x2) {
        ...
        f[2] = v1.child(0).asFloat();
        f[3] = v1.child(1).asFloat();
        UsdUfe::float2half_4f(f, values + count4 * 2);
        count4 += 2;
    }

    if (count & 0x1) {
        auto v = plug.elementByLogicalIndex(count4);
        values[count4 * 2 + 0] = UsdUfe::float2half_1f(v.child(0).asFloat());
        values[count4 * 2 + 1] = UsdUfe::float2half_1f(v.child(1).asFloat());
    }
    ...
    const size_t  count)
{
    ...
    for (uint32_t i = 0, j = 0; i < count8; i += 8, j += 24) {
        ...
        UsdUfe::float2half_8f(r, values + j);
        UsdUfe::float2half_8f(r + 8, values + j + 8);
        UsdUfe::float2half_8f(r + 16, values + j + 16);
    }
    ...
    const size_t  count)
{
    ...
    if (count & 0x1) {
        ...
        f[2] = v0.child(2).asFloat();
        f[3] = v0.child(3).asFloat();
        UsdUfe::float2half_4f(f, values + count2 * 4);
    }
...
MStatus DgNodeHelper::setVec2(MObject node, MObject attr, const GfHalf* const xy)
{
    ...
    MPlug             plug(node, attr);
    AL_MAYA_CHECK_ERROR(plug.child(0).setValue(UsdUfe::float2half_1f(xy[0])), errorString);
    AL_MAYA_CHECK_ERROR(plug.child(1).setValue(UsdUfe::float2half_1f(xy[1])), errorString);
    return MS::kSuccess;
}
...
MStatus DgNodeHelper::setVec3(MObject node, MObject attr, const GfHalf* const xyz)
{
    ...
    MPlug             plug(node, attr);
    AL_MAYA_CHECK_ERROR(plug.child(0).setValue(UsdUfe::float2half_1f(xyz[0])), errorString);
    AL_MAYA_CHECK_ERROR(plug.child(1).setValue(UsdUfe::float2half_1f(xyz[1])), errorString);
    AL_MAYA_CHECK_ERROR(plug.child(2).setValue(UsdUfe::float2half_1f(xyz[2])), errorString);
    return MS::kSuccess;
}
...
MStatus DgNodeHelper::setVec4(MObject node, MObject attr, const GfHalf* const xyzw)
{
    ...
    MPlug             plug(node, attr);
    AL_MAYA_CHECK_ERROR(plug.child(0).setValue(UsdUfe::float2half_1f(xyzw[0])), errorString);
    AL_MAYA_CHECK_ERROR(plug.child(1).setValue(UsdUfe::float2half_1f(xyzw[1])), errorString);
    AL_MAYA_CHECK_ERROR(plug.child(2).setValue(UsdUfe::float2half_1f(xyzw[2])), errorString);
    AL_MAYA_CHECK_ERROR(plug.child(3).setValue(UsdUfe::float2half_1f(xyzw[3])), errorString);
    return MS::kSuccess;
}
...
MStatus DgNodeHelper::getVec2(MObject node, MObject attr, GfHalf* xy)
{
    ...
    xy[0] = UsdUfe::float2half_1f(fxy[0]);
    xy[1] = UsdUfe::float2half_1f(fxy[1]);
    return status;
}
...
MStatus DgNodeHelper::getVec3(MObject node, MObject attr, GfHalf* xyz)
{
    ...
    UsdUfe::float2half_4f(fxyz, xyzw);
    xyz[0] = xyzw[0];
    xyz[1] = xyzw[1];
    xyz[2] = xyzw[2];
    return status;
...
MStatus DgNodeHelper::getVec4(MObject node, MObject attr, GfHalf* xyzw)
{
    ...
    UsdUfe::float2half_4f(fxyzw, xyzw);
    return status;
}
