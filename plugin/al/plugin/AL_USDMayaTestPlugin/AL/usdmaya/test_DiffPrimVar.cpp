...
TEST(DiffPrimVar, guessUVInterpolationType)
{
    ...
    MFloatArray u;
    MFloatArray v;
    for (int i = 0; i < 31; ++i) indices.append(i);
    {
        u.setLength(31);
        v.setLength(31);
        for (int i = 0; i < 31; ++i) {
...
TEST(DiffPrimVar, guessUVInterpolationTypeExtended)
{
    ...
    for (int i = 4; i < 8; ++i) { indices[i] = 2; }
    for (int i = 8; i < 12; ++i) { indices[i] = 3; }
    for (int i = 12; i < 16; ++i) { indices[i] = 4; }
    for (int i = 16; i < 20; ++i) { indices[i] = 5; }
    for (int i = 20; i < 24; ++i) { indices[i] = 6; }
    for (int i = 24; i < 28; ++i) { indices[i] = 7; }
    for (int i = 28; i < 31; ++i) { indices[i] = 8; }
...
TEST(DiffPrimVar, guessVec3InterpolationTypef)
{
    ...
    {
        u.setLength(31);
        for (int i = 0; i < 31; ++i) { u[i] = MFloatVector(1.0f, 2.0f, 3.0f); }
    }
...
TEST(DiffPrimVar, guessVec3InterpolationTypeExtensivef)
{
    ...
    for (int i = 0; i < 4; ++i) { u[i] = MFloatVector(1.0f, 2.0f, 3.0f); }
    for (int i = 4; i < 8; ++i) { u[i] = MFloatVector(1.1f, 2.1f, 3.1f); }
    for (int i = 8; i < 12; ++i) { u[i] = MFloatVector(1.2f, 2.2f, 3.2f); }
    for (int i = 12; i < 16; ++i) { u[i] = MFloatVector(1.3f, 2.3f, 3.3f); }
    for (int i = 16; i < 20; ++i) { u[i] = MFloatVector(1.4f, 2.4f, 3.4f); }
    for (int i = 20; i < 24; ++i) { u[i] = MFloatVector(1.5f, 2.5f, 3.5f); }
    for (int i = 24; i < 28; ++i) { u[i] = MFloatVector(1.6f, 2.6f, 3.6f); }
    for (int i = 28; i < 31; ++i) { u[i] = MFloatVector(1.7f, 2.7f, 3.7f); }
...
TEST(DiffPrimVar, guessVec3InterpolationTypeExtendedd)
{
    ...
    {
        u.setLength(31);
        for (int i = 0; i < 31; ++i) { u[i] = MVector(1.0f, 2.0f, 3.0f); }
    }
    MIntArray faceCounts;
    faceCounts.append(4);
    faceCounts.append(4);
...
TEST(DiffPrimVar, guessVec3InterpolationTypeExtensived)
{
    ...
    for (int i = 0; i < 4; ++i) { u[i] = MVector(1.0f, 2.0f, 3.0f); }
    for (int i = 4; i < 8; ++i) { u[i] = MVector(1.1f, 2.1f, 3.1f); }
    for (int i = 8; i < 12; ++i) { u[i] = MVector(1.2f, 2.2f, 3.2f); }
    for (int i = 12; i < 16; ++i) { u[i] = MVector(1.3f, 2.3f, 3.3f); }
    for (int i = 16; i < 20; ++i) { u[i] = MVector(1.4f, 2.4f, 3.4f); }
    for (int i = 20; i < 24; ++i) { u[i] = MVector(1.5f, 2.5f, 3.5f); }
    for (int i = 24; i < 28; ++i) { u[i] = MVector(1.6f, 2.6f, 3.6f); }
    for (int i = 28; i < 31; ++i) { u[i] = MVector(1.7f, 2.7f, 3.7f); }
...
TEST(DiffPrimVar, guessVec4InterpolationTypef)
{
    ...
    {
        u.setLength(31);
        for (int i = 0; i < 31; ++i) { u[i] = MFloatPoint(1.0f, 2.0f, 3.0f); }
    }
...
TEST(DiffPrimVar, guessVec4InterpolationTypeExtensivef)
{
    ...
    for (int i = 0; i < 4; ++i) { u[i] = MFloatPoint(1.0f, 2.0f, 3.0f); }
    for (int i = 4; i < 8; ++i) { u[i] = MFloatPoint(1.1f, 2.1f, 3.1f); }
    for (int i = 8; i < 12; ++i) { u[i] = MFloatPoint(1.2f, 2.2f, 3.2f); }
    for (int i = 12; i < 16; ++i) { u[i] = MFloatPoint(1.3f, 2.3f, 3.3f); }
    for (int i = 16; i < 20; ++i) { u[i] = MFloatPoint(1.4f, 2.4f, 3.4f); }
    for (int i = 20; i < 24; ++i) { u[i] = MFloatPoint(1.5f, 2.5f, 3.5f); }
    for (int i = 24; i < 28; ++i) { u[i] = MFloatPoint(1.6f, 2.6f, 3.6f); }
    for (int i = 28; i < 31; ++i) { u[i] = MFloatPoint(1.7f, 2.7f, 3.7f); }
...
TEST(DiffPrimVar, guessVec4InterpolationTypeExtendedd)
{
    ...
    {
        u.setLength(31);
        for (int i = 0; i < 31; ++i) { u[i] = MPoint(1.0f, 2.0f, 3.0f); }
    }
    MIntArray faceCounts;
    faceCounts.append(4);
    faceCounts.append(4);
...
TEST(DiffPrimVar, guessVec4InterpolationTypeExtensived)
{
    ...
    for (int i = 0; i < 4; ++i) { u[i] = MPoint(1.0f, 2.0f, 3.0f); }
    for (int i = 4; i < 8; ++i) { u[i] = MPoint(1.1f, 2.1f, 3.1f); }
    for (int i = 8; i < 12; ++i) { u[i] = MPoint(1.2f, 2.2f, 3.2f); }
    for (int i = 12; i < 16; ++i) { u[i] = MPoint(1.3f, 2.3f, 3.3f); }
    for (int i = 16; i < 20; ++i) { u[i] = MPoint(1.4f, 2.4f, 3.4f); }
    for (int i = 20; i < 24; ++i) { u[i] = MPoint(1.5f, 2.5f, 3.5f); }
    for (int i = 24; i < 28; ++i) { u[i] = MPoint(1.6f, 2.6f, 3.6f); }
    for (int i = 28; i < 31; ++i) { u[i] = MPoint(1.7f, 2.7f, 3.7f); }
