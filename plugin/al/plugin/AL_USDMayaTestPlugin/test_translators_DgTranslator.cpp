...
TEST(translators_DgNodeTranslator, vec2h_array)
{
    ...
    for (int i = 0; i < SIZE * VEC_SIZE; ++i) { orig[i] = randFloat(); }
    ...
    for (int i = 0; i < SIZE * VEC_SIZE; ++i) { EXPECT_EQ(orig[i], result[i]); }
    delete[] orig;
    delete[] result;
}
TEST(translators_DgNodeTranslator, vec2i_array)
{
    ...
    for (int i = 0; i < SIZE * VEC_SIZE; ++i) { orig[i] = randInt32(); }
...
TEST(translators_DgNodeTranslator, matrix2x2f_array)
{
    ...
    ;
    for (int i = 0; i < SIZE * 4; ++i) { orig[i] = randFloat(); }
    ...
    for (int i = 0; i < SIZE * 4; ++i) { EXPECT_NEAR(orig[i], result[i], 1e-5f); }
    delete[] orig;
    delete[] result;
}
TEST(translators_DgNodeTranslator, matrix2x2d_array)
{
    ...
    ;
    for (int i = 0; i < SIZE * 4; ++i) { orig[i] = randDouble(); }
...
TEST(translators_DgNodeTranslator, matrix3x3f_array)
{
    ...
    ;
    for (int i = 0; i < SIZE * 9; ++i) { orig[i] = randFloat(); }
    ...
    for (int i = 0; i < SIZE * 9; ++i) { EXPECT_NEAR(orig[i], result[i], 1e-5f); }
    delete[] orig;
    delete[] result;
}
TEST(translators_DgNodeTranslator, matrix3x3d_array)
{
    ...
    ;
    for (int i = 0; i < SIZE * 9; ++i) { orig[i] = randDouble(); }
...
TEST(translators_DgNodeTranslator, matrix4x4f_array)
{
    ...
    ;
    for (int i = 0; i < SIZE * 16; ++i) { orig[i] = randFloat(); }
...
TEST(translators_DgNodeTranslator, string_array)
{
    ...
    for (int i = 0; i < SIZE; ++i) { orig[i] = text[randInt32() % 5]; }
    ...
    for (int i = 0; i < SIZE; ++i) { EXPECT_EQ(orig[i], result[i]); }
    delete[] orig;
    delete[] result;
}
...
TEST(translators_DgNodeTranslator, time_array)
{
    ...
    float* result = new float[SIZE];
    ;
    for (int i = 0; i < SIZE; ++i) { orig[i] = MTime(randFloat(), MTime::kSeconds).value(); }
    ...
    for (int i = 0; i < SIZE; ++i) { EXPECT_NEAR(orig[i], result[i], 1e-5f); }
    delete[] orig;
    delete[] result;
}
...
TEST(translators_DgNodeTranslator, angle_array)
{
    ...
    float* result = new float[SIZE];
    ;
    for (int i = 0; i < SIZE; ++i) { orig[i] = MAngle(randFloat(), MAngle::kRadians).value(); }
...
TEST(translators_DgNodeTranslator, distance_array)
{
    ...
    float* result = new float[SIZE];
    ;
    for (int i = 0; i < SIZE; ++i) { orig[i] = MDistance(randFloat(), MDistance::kInches).value(); }
...
TEST(translators_DgNodeTranslator, matrix2x2f_test)
{
    ...
    for (int i = 0; i < 4; ++i) { orig[i] = randDouble(); }
    ...
    for (int i = 0; i < 4; ++i) { EXPECT_NEAR(orig[i], result[i], 1e-5f); }
    delete[] orig;
    delete[] result;
}
...
TEST(translators_DgNodeTranslator, matrix3x3f_test)
{
    ...
    for (int i = 0; i < 9; ++i) { orig[i] = randDouble(); }
    ...
    for (int i = 0; i < 9; ++i) { EXPECT_NEAR(orig[i], result[i], 1e-5f); }
    delete[] orig;
    delete[] result;
}
...
TEST(translators_DgNodeTranslator, matrix4x4f_test)
{
    ...
    for (int i = 0; i < 4; ++i) {
        for (int j = 0; j < 4; ++j) { orig[i][j] = randFloat(); }
    }
    ...
    for (int i = 0; i < 4; ++i) {
        for (int j = 0; j < 4; ++j) { EXPECT_NEAR(orig[i][j], result[i][j], 1e-5f); }
    }
}
