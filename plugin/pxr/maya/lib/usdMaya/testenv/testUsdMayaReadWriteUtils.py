...
class testUsdMayaReadWriteUtils(unittest.TestCase):
    ...
    def testGetVtValue(self):
        ...
        vec3f = mayaUsdLib.WriteUtil.GetVtValue("group1.scale",
                Sdf.ValueTypeNames.Vector3f)
        self.assertEqual(vec3f, Gf.Vec3f(1.0))
        self.assertIsInstance(vec3f, Gf.Vec3f)

        vec3d = mayaUsdLib.WriteUtil.GetVtValue("group1.scale",
        ...
        cmds.setAttr("group1.myArray", 3, (0, 1, 2), (1, 2, 3), (2, 3, 4),
                type="vectorArray")
        float3Array = mayaUsdLib.WriteUtil.GetVtValue("group1.myArray",
                Sdf.ValueTypeNames.Float3Array)
        self.assertEqual(float3Array,
                Vt.Vec3fArray([(0, 1, 2), (1, 2, 3), (2, 3, 4)]))
        point3Array = mayaUsdLib.WriteUtil.GetVtValue("group1.myArray",
        ...
        string = mayaUsdLib.WriteUtil.GetVtValue("group1.myString",
                Sdf.ValueTypeNames.String)
        self.assertEqual(string, "a_b_c")
        token = mayaUsdLib.WriteUtil.GetVtValue("group1.myString",
        ...
        color3f = mayaUsdLib.WriteUtil.GetVtValue("group1.myColor",
                Sdf.ValueTypeNames.Color3f)
        self.assertAlmostEqual(color3f[0], 0.2176376)
        vec3f = mayaUsdLib.WriteUtil.GetVtValue("group1.myColor",
                Sdf.ValueTypeNames.Vector3f)
    ...
    def testSetMayaAttr(self):
        ...
        attrName = mayaUsdLib.ReadUtil.FindOrCreateMayaAttr(
                ...
                "myAssetPath",
                "kittens")
        self.assertTrue(mayaUsdLib.ReadUtil.SetMayaAttr(attrName,
        ...
        self.assertTrue(mayaUsdLib.ReadUtil.SetMayaAttr("group1.scale",
