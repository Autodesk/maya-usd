...
void CommandGuiHelperTestCMD::makeGUI()
{
  ...
  CommandGuiHelper commandOpts("AL_usdmaya_CommandGuiHelperTest", "Unit Testy Stuff", "Test", "USD/Tests/CommandGuiHelperTest");
  ...
  commandOpts.addStringOption("qstring", "String", "hello", true, CommandGuiHelper::kStringMustHaveValue);
  commandOpts.addFilePathOption("fp1", "File Path Load", CommandGuiHelper::kLoad, "All Files (*.*) (*.*)", CommandGuiHelper::kStringMustHaveValue);
  commandOpts.addFilePathOption("fp2", "File Path Save", CommandGuiHelper::kSave, "All Files (*.*) (*.*)", CommandGuiHelper::kStringMustHaveValue);
  commandOpts.addFilePathOption("fp3", "File Path Dir", CommandGuiHelper::kDirectory, "All Files (*.*) (*.*)", CommandGuiHelper::kStringMustHaveValue);
  commandOpts.addFilePathOption("fp4", "File Path Dir + File", CommandGuiHelper::kDirectoryWithFiles, "All Files (*.*) (*.*)", CommandGuiHelper::kStringMustHaveValue);
  commandOpts.addFilePathOption("fp5", "File Path Multi File", CommandGuiHelper::kMultiLoad, "All Files (*.*) (*.*)", CommandGuiHelper::kStringMustHaveValue);
}
...
bool test_CommandGuiHelper()
{
  ...
  // generate the GUI.
  {
    ...
    CommandGuiHelper options("polyCube", "Create Polygon Cube", "Create", "USD/polygons/Create Cube");
  ...
  {
    CommandGuiHelper options("pointLight", "Create Point Light", "Create", "USD/lights/Create Point Light");
