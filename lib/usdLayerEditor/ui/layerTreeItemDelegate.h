...
#ifndef USDLAYEREDITOR_LAYERTREEITEMDELEGATE_H
#define USDLAYEREDITOR_LAYERTREEITEMDELEGATE_H
 ...
 *
 */
class LAYEREDITOR_UI_PUBLIC LayerTreeItemDelegate : public QStyledItemDelegate
{
    Q_OBJECT
public:
