...
#ifndef USDLAYEREDITOR_DIRTYLAYERSCOUNTBADGE_H
#define USDLAYEREDITOR_DIRTYLAYERSCOUNTBADGE_H
...
class LAYEREDITOR_UI_PUBLIC DirtyLayersCountBadge : public QWidget
{
    Q_OBJECT
public:
