...
//
#ifndef USDLAYEREDITOR_USDSYNTAXHIGHLIGHTER_H
 ...
 */
class LayerEditorAPI UsdSyntaxHighlighter : public QSyntaxHighlighter
{
    Q_OBJECT
...
#endif // USDLAYEREDITOR_USDSYNTAXHIGHLIGHTER_H
