...
#define USDLAYEREDITOR_ABSTRACTCOMMANDHOOK_H
 ...
 * stages. These methods will be "hooked" by the DCC-specific derived class to call commands to
 do the work.
 *
 */
...
public:
    ...
    virtual void lockLayer(UsdLayer usdLayer, LayerLockType lockState, bool includeSubLayers) = 0;
