...
#ifndef USDLAYEREDITOR_LAYERTREEITEM_H
#define USDLAYEREDITOR_LAYERTREEITEM_H
...
class LayerEditorAPI LayerTreeItem : public QStandardItem
{
public:
    LayerTreeItem(
