...
//
#ifndef MAYAHYDRALIB_AL_PROXY_USDIMAGING_DELEGATE_H
#define MAYAHYDRALIB_AL_PROXY_USDIMAGING_DELEGATE_H
...
class MayaHydraProxyUsdImagingDelegate : public UsdImagingDelegate
{
public:
    MayaHydraProxyUsdImagingDelegate(
        HdRenderIndex*         parentIndex,
        SdfPath const&         delegateID,
        MayaUsdProxyShapeBase* proxy,
        const MDagPath&        dagPath);
    virtual ~MayaHydraProxyUsdImagingDelegate();
...
#endif // MAYAHYDRALIB_AL_PROXY_USDIMAGING_DELEGATE_H
