#ifndef MAYAHYDRALIB_AL_PROXY_ADAPTER_H
#define MAYAHYDRALIB_AL_PROXY_ADAPTER_H

#include <mayaHydraLib/adapters/shapeAdapter.h>
#include <mayaHydraLib/delegates/proxyUsdImagingDelegate.h>
#if defined(MAYAUSD_VERSION)
    #include <mayaUsd/listeners/proxyShapeNotice.h>
#else
    #include <mayaHydraLib/usd/proxyShapeNotice.h>
#endif
...
class MayaHydraProxyAdapter
    : public MayaHydraShapeAdapter
    , public TfWeakBase
{
public:
    MayaHydraProxyAdapter(MayaHydraDelegateCtx* delegate, const MDagPath& dag);

    ~MayaHydraProxyAdapter();
...
private:
    ...
    std::unique_ptr<MayaHydraProxyUsdImagingDelegate> _usdDelegate;
};

PXR_NAMESPACE_CLOSE_SCOPE

#endif // MAYAHYDRALIB_AL_PROXY_ADAPTER_H
