...
//
#include <mayaHydraLib/renderItemClient/rendererPlugin.h>
...
HdRenderDelegate*
MayaHydraRenderItemRendererPlugin::CreateRenderDelegate()
{
...
void
MayaHydraRenderItemRendererPlugin::DeleteRenderDelegate(HdRenderDelegate *renderDelegate)
{
    delete renderDelegate;
}

bool 
MayaHydraRenderItemRendererPlugin::IsSupported() const
{
