...
//
#ifndef MAYAHYDRALIB_RENDER_ITEM_RENDERER_PLUGIN_H
#define MAYAHYDRALIB_RENDER_ITEM_RENDERER_PLUGIN_H
...
///
/// \class MayaHydraRenderItemRendererPlugin
///
...
///
class MayaHydraRenderItemRendererPlugin final : public HdRendererPlugin {
public:
    MayaHydraRenderItemRendererPlugin() = default;
    virtual ~MayaHydraRenderItemRendererPlugin() = default;
...
private:
    ...
    MayaHydraRenderItemRendererPlugin(const MayaHydraRenderItemRendererPlugin&)             = delete;
    MayaHydraRenderItemRendererPlugin &operator =(const MayaHydraRenderItemRendererPlugin&) = delete;
};
