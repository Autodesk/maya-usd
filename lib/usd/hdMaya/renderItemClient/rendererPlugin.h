...
//
#ifndef HDMAYA_RENDER_ITEM_RENDERER_PLUGIN_H
#define HDMAYA_RENDER_ITEM_RENDERER_PLUGIN_H
...
///
/// \class HdMayaRenderItemRendererPlugin
///
...
///
class HdMayaRenderItemRendererPlugin final : public HdRendererPlugin {
public:
    HdMayaRenderItemRendererPlugin() = default;
    virtual ~HdMayaRenderItemRendererPlugin() = default;
...
private:
    ...
    HdMayaRenderItemRendererPlugin(const HdMayaRenderItemRendererPlugin&)             = delete;
    HdMayaRenderItemRendererPlugin &operator =(const HdMayaRenderItemRendererPlugin&) = delete;
};
