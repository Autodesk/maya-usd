...
{
    HdRendererPluginRegistry::Define<HdMayaRenderItemRendererPlugin, HdRendererPlugin>();
}
...
void
HdMayaRenderItemRendererPlugin::DeleteRenderDelegate(HdRenderDelegate *renderDelegate)
{
    delete renderDelegate;
}

bool 
HdMayaRenderItemRendererPlugin::IsSupported() const
{
