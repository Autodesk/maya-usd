...
//
#ifndef HDMAYA_SCENE_DELEGATE_2_H
#define HDMAYA_SCENE_DELEGATE_2_H
...
class HdMayaScene2Delegate : public HdMayaDelegateCtx
{
public:
    HDMAYA_API
    HdMayaScene2Delegate(const InitData& initData);

    HDMAYA_API
    ~HdMayaScene2Delegate() override;
...
typedef std::shared_ptr<HdMayaScene2Delegate> MayaSceneDelegate2SharedPtr;
