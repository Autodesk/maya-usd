...
MAYAUSD_NS_DEF
{
        ...
        , fRootPrimPath("/")
    {
        ...
        fTreeModel = TreeModelFactory::createFromStage(
            fStage, mayaQtUtil, matchingImportData, this, &nbItems);
    ...
    bool USDImportDialog::execute()
    {
        ...
        // 	treePal.setBrush(QPalette::Active, QPalette::AlternateBase,
        // treePal.color(QPalette::Active, QPalette::Base).lighter(130));
