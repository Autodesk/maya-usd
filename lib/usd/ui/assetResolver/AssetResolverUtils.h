...
#ifndef MAYAUSDUI_USD_ASSETRESOLVERUTILS_H
#define MAYAUSDUI_USD_ASSETRESOLVERUTILS_H
...
\brief A utility class for managing Autodesk USD Asset Resolver settings in Maya.
*/
class MAYAUSD_UI_PUBLIC AssetResolverUtils
{
public:
...
#endif // MAYAUSDUI_USD_ASSETRESOLVERUTILS_H
