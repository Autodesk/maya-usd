...
MAYAUSD_NS_DEF
{
    ...
    protected:
        ...
        /**
         * \brief Create the list of data cells used to represent the given USD Prim's data in the
         * tree. \param prim The USD Prim for which to create the list of data cells. \return The
         * List of data cells used to represent the given USD Prim's data in the tree.
         */
