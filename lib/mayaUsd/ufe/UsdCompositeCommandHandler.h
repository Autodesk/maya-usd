...
//! \brief Interface to create a UsdCompositeCommandHandler interface object.
class MAYAUSD_CORE_PUBLIC UsdCompositeCommandHandler : public UsdBatchOpsHandler
{
public:
    //! Create a UsdCompositeCommandHandler.
    static std::shared_ptr<UsdCompositeCommandHandler> create();
