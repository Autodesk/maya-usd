...
/*static*/
UsdUndoDuplicateCommand::Ptr UsdUndoDuplicateCommand::create(const UsdPrim& srcPrim, const Ufe::Path& ufeSrcPath)
{
	return std::make_shared<UsdUndoDuplicateCommand>(srcPrim, ufeSrcPath);
}

const SdfPath& UsdUndoDuplicateCommand::usdDstPath() const
{
	return fUsdDstPath;
}

/*static*/
void UsdUndoDuplicateCommand::primInfo(const UsdPrim& srcPrim, SdfPath& usdDstPath, SdfLayerHandle& srcLayer)
{
...
/*static*/
bool UsdUndoDuplicateCommand::duplicate(const SdfLayerHandle& layer, const SdfPath& usdSrcPath, const SdfPath& usdDstPath)
{
