...
public:
    ...
    bool default_CopyFromPrim(const UsdPrim& prim) { return base_t::CopyFromPrim(prim); }
    bool CopyFromPrim(const UsdPrim& prim) override
    {
        return this->template CallVirtual<bool>("CopyFromPrim", &This::default_CopyFromPrim)(prim);
    }
    ...
    {
        return this->template CallVirtual<bool>("ApplySchema", &This::default_ApplySchema)(
            modifier);
    }
...
void wrapSchemaApiAdaptor()
{
    ...
    boost::python::class_<SchemaApiAdaptorWrapper, boost::noncopyable>(
        ...
        .def("ApplySchema", &This::ApplySchema, &SchemaApiAdaptorWrapper::default_ApplySchema)
