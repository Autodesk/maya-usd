...
/* static */
void*
MayaUSDImportCommand::creator()
{
    return new MayaUSDImportCommand();
}

/* virtual */
std::unique_ptr<UsdMaya_ReadJob> MayaUSDImportCommand::initializeReadJob(const MayaUsd::ImportData & data, 
...
/* virtual */
MStatus
MayaUSDImportCommand::doIt(const MArgList & args)
{
    MStatus status;
