...
MAYAUSD_NS_DEF
{
    ...
    MSyntax MayaUSDImportCommand::createSyntax()
    {
        ...
        syntax.addFlag(
            kShadingModeFlag, UsdMayaJobImportArgsTokens->shadingMode.GetText(), MSyntax::kString);
        syntax.addFlag(
            kAssemblyRepFlag, UsdMayaJobImportArgsTokens->assemblyRep.GetText(), MSyntax::kString);
        syntax.addFlag(
            kMetadataFlag, UsdMayaJobImportArgsTokens->metadata.GetText(), MSyntax::kString);
    ...
    std::unique_ptr<UsdMaya_ReadJob> MayaUSDImportCommand::initializeReadJob(
        const MayaUsd::ImportData& data, const UsdMayaJobImportArgs& args)
    {
