...
MAYAUSD_NS_DEF
{
    ...
    MSyntax MayaUSDExportCommand::createSyntax()
    {
        ...
        syntax.addFlag(
            ...
            MSyntax::kString);
        syntax.addFlag(
            kVerboseFlag, UsdMayaJobExportArgsTokens->verbose.GetText(), MSyntax::kNoArg);
    ...
    /* virtual */
    std::unique_ptr<UsdMaya_WriteJob> MayaUSDExportCommand::initializeWriteJob(
        const PXR_NS::UsdMayaJobExportArgs& args)
    {
