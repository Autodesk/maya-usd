...
std::string UsdMayaUtilFileSystem::getPathRelativeToLayerFile(const std::string& fileName, const PXR_NS::SdfLayerHandle& layer)
{
    if (!layer)
        return fileName;
...
bool UsdMayaUtilFileSystem::prepareLayerSaveUILayer(const PXR_NS::SdfLayerHandle& layer, bool useSceneFileForRoot)
{
