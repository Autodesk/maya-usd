...
namespace
{
    ...
    {
        using Type=bool;
        enum { kNumericType=MFnNumericData::kBoolean };
    ...
    {
        using Type=int;
        enum { kNumericType=MFnNumericData::kInt };
    ...
    template <> struct MakeMayaFnData<MMatrixArray>  : public std::true_type
    {
        ...
        enum { kDataType=MFnData::kMatrixArray };
        enum { kApiType=MFn::kMatrixArrayData };

        static MObject create(FnType& data)
        { return data.create(); }
        
        static void get(const FnType& data, Type& value)
        { data.copyTo(value); }
        
        static void set(FnType& data, const Type& value)
        { data.set(value); }
    ...
    template <> struct MakeMayaFnData<MIntArray>  : public std::true_type
    {
        ...
        enum { kDataType=MFnData::kIntArray };
        enum { kApiType=MFn::kIntArrayData };
    ...
    template <> struct MakeMayaFnData<MPointArray>  : public std::true_type
    {
        ...
        enum { kDataType=MFnData::kPointArray };
        enum { kApiType=MFn::kPointArrayData };
    ...
    template <> struct MakeMayaFnData<MMatrix>  : public std::true_type
    {
        ...
        enum { kDataType=MFnData::kMatrix };
        enum { kApiType=MFn::kMatrixData };
    ...
    template <> struct MakeMayaFnData<float3>  : public std::true_type
    {
        ...
        enum { kDataType=MFnData::kNumeric };
        enum { kApiType=MFn::kNumericData };

        static MObject create(FnType& data)
        { return data.create(MFnNumericData::k3Float); }
        
        static void get(FnType& data, Type& value)
        { data.getData(value[0], value[1], value[2]); }
    ...
    template <> struct MakeMayaFnData<double3>  : public std::true_type
    {
        ...
        static MObject create(FnType& data)
        { return data.create(MFnNumericData::k3Double); }
    ...
    template <> struct MakeMayaFnData<MString>  : public std::true_type
    {
        ...
        enum { kDataType=MFnData::kString };
        enum { kApiType=MFn::kStringData };
    ...
    struct MPlugUtils<MAYA_Type, typename std::enable_if<MakeMayaFnData<MAYA_Type>::value>::type>
    {
        ...
        static bool valid(const MPlug& plug)
        {
            return Converter::hasAttrType(FnTypeHelper::kDataType);
        }
    ...
    struct MDataHandleConvert
    {
        ...
        static typename std::enable_if<C==NeedsGammaCorrection::kNo, void>::type convert(const USD_Type& src, MDataHandle& dst, const ConverterArgs&)
        {
            MAYA_Type tmpDst;
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kNo, void>::type convert(const MDataHandle& src, USD_Type& dst, const ConverterArgs&)
        {
            MAYA_Type tmpSrc;
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kYes, void>::type convert(const USD_Type& src, MDataHandle& dst, const ConverterArgs& args)
        {
            MAYA_Type tmpDst;
            USD_Type tmpSrc = args._doGammaCorrection ? UsdMayaColorSpace::ConvertLinearToMaya(src) : src;
            TypedConverter<MAYA_Type,USD_Type>::convert(tmpSrc,tmpDst);
            MDataHandleUtils<MAYA_Type>::set(dst, tmpDst);
        }
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kYes, void>::type convert(const MDataHandle& src, USD_Type& dst, const ConverterArgs& args)
        {
            MAYA_Type tmpSrc;
            MDataHandleUtils<MAYA_Type>::get(src, tmpSrc);
            TypedConverter<MAYA_Type,USD_Type>::convert(tmpSrc,dst);
    ...
    struct MPlugConvert
    {
        // MPlug <--> USD_Type
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kNo, void>::type convert(const USD_Type& src, MPlug& dst, const ConverterArgs&)
        {
            MAYA_Type tmpDst;
            TypedConverter<MAYA_Type,USD_Type>::convert(src,tmpDst);
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kNo, void>::type convert(const MPlug& src, USD_Type& dst, const ConverterArgs&)
        {
            MAYA_Type tmpSrc;
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kNo, void>::type convert(const USD_Type& src, const MPlug& plug, MDGModifier& dst, const ConverterArgs&)
        {
            MAYA_Type tmpDst;
            TypedConverter<MAYA_Type,USD_Type>::convert(src,tmpDst);
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kYes, void>::type convert(const USD_Type& src, MPlug& dst, const ConverterArgs& args)
        {
            MAYA_Type tmpDst;
            USD_Type tmpSrc = args._doGammaCorrection ? UsdMayaColorSpace::ConvertLinearToMaya(src) : src;
            TypedConverter<MAYA_Type,USD_Type>::convert(tmpSrc,tmpDst);
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kYes, void>::type convert(const MPlug& src, USD_Type& dst, const ConverterArgs& args)
        {
            MAYA_Type tmpSrc;
            MPlugUtils<MAYA_Type>::get(src, tmpSrc);
            TypedConverter<MAYA_Type,USD_Type>::convert(tmpSrc,dst);
        ...
        template<NeedsGammaCorrection C = ColorCorrection>
        static typename std::enable_if<C==NeedsGammaCorrection::kYes, void>::type convert(const USD_Type& src, const MPlug& plug, MDGModifier& dst, const ConverterArgs& args)
        {
            MAYA_Type tmpDst;
            USD_Type tmpSrc = args._doGammaCorrection ? UsdMayaColorSpace::ConvertLinearToMaya(src) : src;
            TypedConverter<MAYA_Type,USD_Type>::convert(tmpSrc,tmpDst);
        ...
        static void convert(const UsdAttribute& src, MPlug& plug, MDGModifier& dst, const ConverterArgs& args)
        {
            USD_Type tmpSrc;
            src.Get<USD_Type>(&tmpSrc, args._timeCode);
        ...
        static void convert(const VtValue& src, MPlug& plug, MDGModifier& dst, const ConverterArgs& args)
        {
            const USD_Type& tmpSrc = src.Get<USD_Type>();
            convert(tmpSrc,plug,dst,args);
        }
    ...
    struct GenerateConverters{
        ...
        {
            converters.emplace(typeName, Converter( typeName
                                                   ...
                                                   , &MPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // UsdAttrToMDGModifierFn
                                                   ...
                                                   , &MPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // VtValueToMDGModifierFn
                                                   , &MDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // MDataHandleToUsdAttrFn
                                                   , &MDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // UsdAttrToMDataHandleFn
                                                   , &MDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // MDataHandleToVtValueFn
                                                   , &MDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // VtValueToMDataHandleFn
                                                   ) );
        }
        ...
        static ConvertStorage generate() {
            ...
            createConverter<float3, GfVec3f, NeedsGammaCorrection::kYes>(converters, SdfValueTypeNames->Color3f);
            createConverter<double3, GfVec3d, NeedsGammaCorrection::kYes>(converters, SdfValueTypeNames->Color3d);
            ...
            createConverter<MMatrixArray, VtArray<GfMatrix4d>>(converters, SdfValueTypeNames->Matrix4dArray);
    ...
    struct GenerateArrayPlugConverters{
        ...
        {
            converters.emplace(typeName, Converter( typeName
                                                   , &MArrayPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // MPlugToUsdAttrFn
                                                   , &MArrayPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // UsdAttrToMPlugFn
                                                   , &MArrayPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // UsdAttrToMDGModifierFn
                                                   , &MArrayPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // MPlugToVtValueFn
                                                   , &MArrayPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // VtValueToMPlugFn
                                                   , &MArrayPlugConvert<MAYA_Type,USD_Type,ColorCorrection>::convert         // VtValueToMDGModifierFn
                                                   , &MArrayDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // MDataHandleToUsdAttrFn
                                                   , &MArrayDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // UsdAttrToMDataHandleFn
                                                   , &MArrayDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // MDataHandleToVtValueFn
                                                   , &MArrayDataHandleConvert<MAYA_Type,USD_Type,ColorCorrection>::convert   // VtValueToMDataHandleFn
                                                   ) );
        }
...
SdfValueTypeName Converter::getUsdTypeName(
    const MPlug& attrPlug,
    const bool translateMayaDoubleToUsdSinglePrecision)
{
    ...
    getMayaAttributeNumericTypedAndUnitDataTypes( attrPlug,
                                                  numericDataType,
                                                  typedDataType,
                                                  unitDataType);
