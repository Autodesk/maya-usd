...
class MaterialCustomControl(object):
    ...
    def _connectTextFieldChangeCallback(self, purpose, textField):
        ...
        ufeUtils.setMayaNiceUndoLabel(callback, getMayaUsdLibString('kLabelSetMaterialBindingUndo'))
    ...
    def _createDropDownField(self, longName, uiNameRes, elementsRes):
        ...
        ufeUtils.setMayaNiceUndoLabel(callback, getMayaUsdLibString('kLabelSetMaterialBindingStrengthUndo'))
