...
class CollectionData(QObject):
    ...
    def computeMembership(self, onlyExpression=False) -> Sequence[str]:
        ...
        If onlyExpression is true, then compute only the member based in the
        expresson of the collection, if any.
