...
__mayaUsdLibStringResources = {
    ...
    'kLabelSetKindUndo': 'Set Kind',
    'kLabelToggleActiveUndo': 'Toggle Active',
    'kLabelToggleInstanceableUndo': 'Toggle Instanceable',
    ...
    'kLabelDefaultMaterial': 'Default',
    'kAnnDefaultMaterial': "Default material assignment to fall back on if other assignments aren't used",
    'kLabelPreviewMaterial': 'Preview',
    'kAnnPreviewMaterial': "Preview material assignment for light-weight and high performance contexts (viewport)",
    'kLabelFullMaterial': 'Render',
    'kAnnFullMaterial': "Render material assignment for high-fidelity and final-quality contexts (rendering)",
    'kAnnShowMaterialInLookdevx': 'Show in LookdevX',
    'kLabelDefaultInheritedMaterial': 'Inherited Default',
    'kLabelDefaultInheritedFromPrim': 'Inherited from Prim',
    'kLabelPreviewInheritedMaterial': 'Inherited Preview',
    'kLabelPreviewInheritedFromPrim': 'Inherited from Prim',
    'kLabelFullInheritedMaterial': 'Inherited Render',
    'kLabelFullInheritedFromPrim': 'Inherited from Prim',
    'kLabelSetMaterialBindingUndo': 'Set Material Binding',
    'kLabelSetMaterialBindingStrengthUndo': 'Set Binding Strength',
