...
StageData::StageData()
{
  m_exitCallbackId = maya::MayaEventManager::instance().registerCallback(_cleanUp, "MayaExiting", "DestroyStageDataOnExit", 0x10000, this);
...
StageData::~StageData()
{
  maya::MayaEventManager::instance().unregisterCallback(m_exitCallbackId);
