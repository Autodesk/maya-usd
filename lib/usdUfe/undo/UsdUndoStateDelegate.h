...
#ifndef USDUFE_UNDO_UNDOSTATE_DELEGATE_H
#define USDUFE_UNDO_UNDOSTATE_DELEGATE_H
...
*/
class USDUFE_PUBLIC UsdUndoStateDelegate : public SdfLayerStateDelegateBase
{
public:
...
#endif // USDUFE_UNDO_UNDOSTATE_DELEGATE_H
