...
//
#ifndef USDUFE_USDTRANSFORM3DSETOBJECTMATRIX_H
#define USDUFE_USDTRANSFORM3DSETOBJECTMATRIX_H
...
class USDUFE_PUBLIC UsdTransform3dSetObjectMatrix : public UsdTransform3dBase
{
public:
...
#endif // USDUFE_USDTRANSFORM3DSETOBJECTMATRIX_H
