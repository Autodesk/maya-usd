...
//
#ifndef USDUFE_USD_POINT_INSTANCE_POSITION_MODIFIER_H
#define USDUFE_USD_POINT_INSTANCE_POSITION_MODIFIER_H
...
/// position.
///
class USDUFE_PUBLIC UsdPointInstancePositionModifier
