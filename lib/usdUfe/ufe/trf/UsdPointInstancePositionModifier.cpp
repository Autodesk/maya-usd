...
UsdUfe::UsdPointInstancePositionModifier::Batches sBatches;
} // namespace
...
USDUFE_VERIFY_CLASS_BASE(base, UsdPointInstancePositionModifier);
USDUFE_VERIFY_CLASS_VIRTUAL_DESTRUCTOR(UsdPointInstancePositionModifier);
USDUFE_VERIFY_CLASS_NOT_MOVE_OR_COPY(UsdPointInstancePositionModifier);
...
UsdPointInstancePositionModifier::Batches& UsdPointInstancePositionModifier::batches()
{
    return sBatches;
}
