...
//
#ifndef USDUFE_USDTRANSFORM3DBASE_H
#define USDUFE_USDTRANSFORM3DBASE_H
...
class USDUFE_PUBLIC UsdTransform3dBase
...
public:
    ...
    USDUFE_DISALLOW_COPY_MOVE_AND_ASSIGNMENT(UsdTransform3dBase);
...
#endif // USDUFE_USDTRANSFORM3DBASE_H
