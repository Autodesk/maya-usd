...
//
#ifndef USDUFE_USD_POINT_INSTANCE_MODIFIER_BASE_H
#define USDUFE_USD_POINT_INSTANCE_MODIFIER_BASE_H
...
// attribute.
//
template <class UsdValueType> struct USDUFE_PUBLIC UsdPointInstanceBatch
{
...
///
template <class UfeValueType, class UsdValueType> class USDUFE_PUBLIC UsdPointInstanceModifierBase
{
public:
    ...
    USDUFE_DISALLOW_COPY_MOVE_AND_ASSIGNMENT(UsdPointInstanceModifierBase);
        ...
        PXR_NS::UsdTimeCode usdTime = PXR_NS::UsdTimeCode::Default())
    {
        ...
        OperationEditRouterContext editContext(
            EditRoutingTokens->RouteTransform, usdAttr.GetPrim());
