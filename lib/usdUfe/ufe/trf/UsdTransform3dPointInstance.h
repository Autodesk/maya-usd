...
//
#ifndef USDUFE_USD_TRANSFORM3D_POINT_INSTANCE_H
#define USDUFE_USD_TRANSFORM3D_POINT_INSTANCE_H
...
//
class USDUFE_PUBLIC UsdTransform3dPointInstance : public UsdTransform3dBase
{
public:
...
//
//
class USDUFE_PUBLIC UsdTransform3dPointInstanceHandler : public Ufe::Transform3dHandler
{
public:
