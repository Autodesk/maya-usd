...
//
#ifndef USDUFE_USDROTATEUNDOABLECOMMAND_H
#define USDUFE_USDROTATEUNDOABLECOMMAND_H
 ...
 */
class USDUFE_PUBLIC UsdRotateUndoableCommand
...
public:
    ...
    USDUFE_DISALLOW_COPY_MOVE_AND_ASSIGNMENT(UsdRotateUndoableCommand);
...
#endif // USDUFE_USDROTATEUNDOABLECOMMAND_H
