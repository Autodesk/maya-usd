...
USDUFE_VERIFY_CLASS_SETUP(UsdSetXformOpUndoableCommandBase, CommonAPITranslateUndoableCmd);
...
USDUFE_VERIFY_CLASS_SETUP(UsdSetXformOpUndoableCommandBase, CommonAPIRotateUndoableCmd);
...
USDUFE_VERIFY_CLASS_SETUP(UsdSetXformOpUndoableCommandBase, CommonAPIScaleUndoableCmd);
...
USDUFE_VERIFY_CLASS_SETUP(UsdTransform3dBase, UsdTransform3dCommonAPI);
