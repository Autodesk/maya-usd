...
//
#ifndef USDUFE_USDSCALEUNDOABLECOMMAND_H
#define USDUFE_USDSCALEUNDOABLECOMMAND_H
 ...
 */
class USDUFE_PUBLIC UsdScaleUndoableCommand
...
public:
    ...
    USDUFE_DISALLOW_COPY_MOVE_AND_ASSIGNMENT(UsdScaleUndoableCommand);
...
#endif // USDUFE_USDSCALEUNDOABLECOMMAND_H
