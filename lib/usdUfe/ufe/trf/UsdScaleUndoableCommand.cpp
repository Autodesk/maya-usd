...
USDUFE_VERIFY_CLASS_SETUP(UsdTRSUndoableCommandBase<PXR_NS::GfVec3f>, UsdScaleUndoableCommand);
USDUFE_VERIFY_CLASS_BASE(Ufe::ScaleUndoableCommand, UsdScaleUndoableCommand);
