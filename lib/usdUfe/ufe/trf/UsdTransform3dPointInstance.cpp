...
#include <usdUfe/ufe/trf/UsdPointInstanceUndoableCommands.h>
#include <usdUfe/ufe/trf/UsdTransform3dBase.h>
...
USDUFE_VERIFY_CLASS_SETUP(UsdTransform3dBase, UsdTransform3dPointInstance);
...
{
    if (!UsdUfe::isAttributeEditAllowed(_positionModifier.getAttribute()))
        return nullptr;
...
{
    if (!UsdUfe::isAttributeEditAllowed(_orientationModifier.getAttribute()))
        return nullptr;
...
{
    if (!UsdUfe::isAttributeEditAllowed(_scaleModifier.getAttribute()))
        return nullptr;
